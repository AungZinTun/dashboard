 ...
 <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="/home"><i class="icon-dashboard"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">2</span></a>
            <!-- <ul class="menu-content">
              <li class="active"><a href="#" data-i18n="nav.dash.main" class="menu-item">Dashboard</a>
              </li>
              <li><a href="dashboard-2.html" data-i18n="nav.dash.main" class="menu-item">Dashboard 2</a>
              </li>
            </ul> -->
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title"> Programs</span></a>
            <ul class="menu-content">
            <li class="navigation-divider text-muted text-small">Communicable Disease</li>
              <li><a href="#" data-i18n="nav.page_layouts.1_column" class="menu-item">HIV/AIDS</a>
              </li>
              <li><a href="#" data-i18n="nav.page_layouts.2_columns" class="menu-item">TB/Leprosy</a>
              </li>
              <li><a href="#" data-i18n="nav.page_layouts.boxed_layout" class="menu-item">Malaria</a>
              </li>
              
              <li class="navigation-divider text-muted text-center">Non Communicable Disease</li>
              <li><a href="#" data-i18n="nav.page_layouts.light_layout" class="menu-item">..</a>
              </li>
              <li class="#">...</li>

              <li><a href="#" data-i18n="nav.page_layouts.dark_layout" class="menu-item">EPI</a>
              </li>
              <li><a href="#" data-i18n="nav.page_layouts.semi_dark_layout" class="menu-item">M&CH</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-users"></i><span data-i18n="nav.project.main" class="menu-title">Resources</span></a>
            <ul class="menu-content">
              <li><a href="invoice-template.html" data-i18n="nav.invoice.invoice_template" class="menu-item">Employee</a>
              </li>
              <li><a href="gallery-grid.html" data-i18n="nav.gallery_pages.gallery_grid" class="menu-item">Finance</a>
              </li>
              <li><a href="search-page.html" data-i18n="nav.search_pages.search_page" class="menu-item">Logistics</a>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-calendar"></i><span data-i18n="nav.cards.main" class="menu-title">Work Plan & Events</span></a>
            <ul class="menu-content">
              <li><a href="card-bootstrap.html" data-i18n="nav.cards.card_bootstrap" class="menu-item">Work Plan</a>
              </li>
              <li><a href="card-actions.html" data-i18n="nav.cards.card_actions" class="menu-item">Special Events</a>
              </li>
            </ul>
          </li>
          ...
          <li class=" navigation-header"><span data-i18n="nav.category.support">Help</span><i data-toggle="tooltip" data-placement="right" data-original-title="Help" ></i>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-help"></i><span data-i18n="nav.support_raise_support.main" class="menu-title">Raise Question </span></a>
          </li>
