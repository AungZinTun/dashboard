        ...
        <div class="card">
            <div class="card-body">
                <div class="card-block">
                    <div class="media">
                        <div class="media-body text-xs-left">
                            <h3 class="deep-orange">200</h3>
                            <span>Health Fascilities</span>
                        </div>
                        <div class="media-right media-middle">
        ...
        <div class="card bg-transparent">
            <div class="card-body">
                <div class="card-block">
                    <div class="media">
                        <div class="media-body text-xs-left">
                            <h3 class="cyan">National HIV/AIDS Program</h3>
                            <span>  <div class="row">
                    <div class="col-xs-6 text-xs-center">
                        <span class="text-muted">CNR-Bact Confirm Target</span>
                        <h2 class="block font-weight-normal">292</h2>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-block">
                    <div class="media">
                        <div class="media-body text-xs-left">
                            <h3 class="cyan">National Malaria Control Program</h3>
                            <span>  <div class="row">
                    <div class="col-xs-6 text-xs-center">
                        <span class="text-muted">CNR-Bact Confirm Target</span>
                        <h2 class="block font-weight-normal">292</h2>
