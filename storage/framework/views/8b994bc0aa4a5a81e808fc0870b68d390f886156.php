      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="#" class="navbar-brand nav-link"><img alt="SHD" src="../../app-assets/images/logo/mohs-long-200" data-expand="../../app-assets/images/logo/mohs-long-200.png" data-collapse="../../app-assets/images/logo//mohs-30.png" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-bell4"></i><span class="tag tag-pill tag-default tag-danger tag-default tag-up">1</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                      ...
                      <div class="media">
                        <div class="media-left valign-middle"><i class="icon-flag icon-bg-circle bg-teal"></i></div>
                        <div class="media-body">
                          <h6 class="media-heading">World TB Day </h6><small>
                            <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">Next Week</time></small>
                        </div>
                      </div></a></li>
                  <li class="dropdown-menu-footer"><a href="javascript:void(0)" class="dropdown-item text-muted text-xs-center">Read all notifications</a></li>
                </ul>
              </li>
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">2
              </span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  <li class="dropdown-menu-header">
                  ...
                  <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">Hopong TMO</h6>
                          <p class="notification-text font-small-3 text-muted">I am waiting your professional opinion</p><small>
                            <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">Today</time></small>
                        </div>
                      </div></a><a href="javascript:void(0)" class="list-group-item">
                      <!-- <div class="media">
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">BangMauk HA </h6>
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/logo/mohs-50.png" alt="avatar"><i></i></span><span class="user-name"> <?php echo e(Auth::user()->name); ?> </span></a>
                  ...
                  <div class="dropdown-divider"></div>
                                <div class="dropdown-item" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                      ...
                                      <i class="icon-power3"></i>  <?php echo e(__('Logout')); ?>
